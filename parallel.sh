...
parallel $MAKEPATH --conf $CONFPATH --release $RELEASE --species {} ::: $SPECIESLIST
...
parallel $UPLOADTOS3PATH --bucket $AWSBUCKET --local {} --remote $REMOTEPATH --AWSACCESS $AWSACCESS --AWSSECRET $AWSSECRET ::: $SPECIESLIST
